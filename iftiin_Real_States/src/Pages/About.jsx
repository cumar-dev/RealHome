  ...
  return (
    <div className="bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 gap-5 p-4 cursor-pointer transition sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="shadow-md bg-white p-4 border-l-5 border-r-5 border-[#8338ec] rounded-md flex justify-center gap-3 items-center flex-col">
